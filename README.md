...
### 教程
#### 1. 新建仓库
![新建仓库](https://github.com/a294465800/HungerValleyCode/images/blob/master/01.png)
![仓库名称](https://github.com/a294465800/HungerValleyCode/images/blob/master/02.png)
#### 2. 设置 github pages
![设置](https://github.com/a294465800/HungerValleyCode/images/blob/master/03.png)
！[找到 github pages](https://github.com/a294465800/HungerValleyCode/images/blob/master/04.png)
！[save](https://github.com/a294465800/HungerValleyCode/images/blob/master/05.png)
> 然后那个链接就是能访问的了，默认打开根目录的`index.html`，所以现在新建这个文件。
#### 3. 新建 `index.html`
> 建议直接`git clone`，如图
！[克隆项目](https://github.com/a294465800/HungerValleyCode/images/blob/master/06.png)
！[克隆成功](https://github.com/a294465800/HungerValleyCode/images/blob/master/07.png)
#### 4. 打开项目， VSCode 之类的，开干
！[新建 index.html](https://github.com/a294465800/HungerValleyCode/images/blob/master/08.png)
![三步提交](https://github.com/a294465800/HungerValleyCode/images/blob/master/09.png)
#### 5. 保存地址，方便下次打开
![保存地址](https://github.com/a294465800/HungerValleyCode/images/blob/master/10.png)
![直接查看结果](https://github.com/a294465800/HungerValleyCode/images/blob/master/11.png)
#### 6. 访问该目录下的其他网页
> 因为默认是打开`index.html`的，那么如果我的另一个`html`想打开咋办？，只要在这个地址后面加上目录就行了，因为当前地址相当于根目录。
![访问我的 test 目录](https://github.com/a294465800/HungerValleyCode/images/blob/master/12.png)

> 直接在原来域上加上目录名称，如果后面不接文件名的话，都是默认访问`index.html`的。

![访问 test 目录下的 html](https://github.com/a294465800/HungerValleyCode/images/blob/master/13.png)